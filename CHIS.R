...
# This code explores the large, publicly available California Health Interview Survey dataset from 2009.
...
# Data Cleaning
# Remove individuals above the age of 84
...
# Do Things Manually
# An attempt to facet the accurate frequency histogram from before (failed, because calculations occur on the fly inside ggplot2)
ggplot(adult, aes (x = SRAGE_P, fill= factor(RBMI))) +
...
# Examine structure of DF_freq and DF_melted
str(DF_freq)
str(DF_melted)
...
# Try the mosaicGG function on different variables and data sets
